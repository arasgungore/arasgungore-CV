  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Prompt Engineer}{Jul 2023 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Developed effective prompts for diverse AI tasks and maintained a high standard of prompt quality and consistency across different competencies, adhering to established guidelines and best practices.}
