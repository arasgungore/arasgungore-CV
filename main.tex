    ...
    \resumeSubheading
      ...
      {Software Engineer}{Dec 2023 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Crafted message types in IDL and designed a data-centric publish-subscribe architecture based on a flyweight design pattern to implement OpenDDS. Utilized QoS policies to facilitate the transmission of both volatile and persistent data across different topics.}
            ...
            \resumeItem{Compared time complexities of computer graphics algorithms by conducting tests over a polygon collection stored in MongoDB to optimize the point-in-polygon problem for a GIS application using Boost libraries.}
        \resumeItemListEnd
