    ...
    \resumeSubheading
      ...
      {Software Engineer}{Dec 2023 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Implemented a fully asynchronous AMQP-based C++ client with a layered architecture for RabbitMQ message broker to ensure seamless message handling between multiple topics.}
        \resumeItemListEnd
