...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Programming:}{ C/C++, C\#, Java, Python, Go, JavaScript, SQL, Scala, MATLAB, R} \\ \vspace{3pt}

        \textbf{Technologies:}{ Django, Node.js, MySQL, Git, Docker, Amazon Web Services, Unity, Linux, Robot Operating System} \\ \vspace{3pt}
