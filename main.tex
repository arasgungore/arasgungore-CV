  ...
  \resumeSubHeadingListStart
    ...
    % \resumeSubheading
      ...
      % {Prompt Engineer}{Jul 2023 \textbf{--} Sep 2023, Freelance}
        % \resumeItemListStart
            % \resumeItem{Crafted elaborate Turkish prompts for various generative AI tasks and used specific formats such as natural language questions and structured inputs to tailor prompts based on LLM's domain to fine-tune the chatbot's capabilities.}
