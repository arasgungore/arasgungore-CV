...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Programming:}{ C, C++, Java, Python, JavaScript, MATLAB, R, SQL, MySQL, Git, Docker, Robot Operating System} \\ \vspace{3pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {AI Research and Development Intern}{Jan 2022 \textbf{--} Feb 2022, Internship}
        \resumeItemListStart
            \resumeItem{Implemented common NLP tasks using transformers such as named-entity recognition (NER), part-of-speech (POS) tagging, sentiment analysis, text classification, and extractive/generative question answering with Hugging Face libraries.}
