...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {B.Sc. in Electrical and Electronics Engineering;   \textbf{GPA: 3.62/4.00}}{Sep 2018 \textbf{--} Jul 2023}
      {Minor Degree in Computer Engineering;
      \textbf{GPA: 3.58/4.00}}{Oct 2020 \textbf{--} Jul 2023}
        % \resumeItemListStart
...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Prompt Engineer}{Jul 2023 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Developed effective prompts for diverse AI tasks such as classification, critique, data extraction, creative/professional/scientific writing, incorrect premises, quiz generation, and summarization.}
            \resumeItem{Maintained a high standard of prompt quality and consistency across different task categories, adhering to established guidelines and best practices.}
...
\section{Research Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Undergraduate Research Assistant}{Oct 2021 \textbf{--} Jun 2022}
        \resumeItemListStart
            \resumeItem{Worked with Assoc. Prof. Ali Emre Pusane on the project “Design and Implementation of Molecular Communication Systems Using Index Modulation” under the TÜBİTAK 2247-C Intern Researcher Scholarship Program (STAR).}
