    ...
    \resumeSubheading
      ...
      {Software Engineer}{Dec 2023 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Utilized IDL to define custom message types and designed a data-centric publish-subscribe architecture using OpenDDS. Implemented QoS measures to enhance system durability and reliability.}
        \resumeItemListEnd
