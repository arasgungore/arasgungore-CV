...
\section{Research Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Research Intern}{Jun 2022 \textbf{--} Aug 2022}
        \resumeItemListStart
            \resumeItem{Currently working with Sinan Özgün Demir on optimization of gait controllers for magnetic walking soft milirobots using ROS.}
        \resumeItemListEnd
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Technologies:}{ Git, Arduino, ROS, Simulink, LTspice, Xilinx ISE} \\ \vspace{2pt}
