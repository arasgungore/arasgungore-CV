    ...
    \resumeSubheading
      ...
      {Undergraduate Researcher}{Jun 2022 \textbf{--} Aug 2022}
        \resumeItemListStart
            ...
            \resumeItem{Designed the project's system and software architecture, algorithm flowchart, and state machine diagram. Implemented and debugged ROS nodes by validating each corresponding physical component functions correctly.}
        \resumeItemListEnd
