  ...
  \resumeSubHeadingListStart
    ...
    % \resumeSubheading
      ...
      % {Prompt Engineer}{Jul 2023 \textbf{--} Sep 2023, Freelance}
        % \resumeItemListStart
            % \resumeItem{Crafted elaborate Turkish prompts for various generative AI tasks, used specific formats such as natural language questions or structured inputs to tailor prompts based on LLM's domain and fine-tune the chatbot's capabilities.}
