    ...
    \resumeSubheading
      ...
      {Software Engineer}{Dec 2023 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Benchmarked computer graphics algorithms over a GeoJSON polygon collection fetched from MongoDB. Developed a cross-platform concurrent program to optimize the point-in-polygon problem for a GIS application using Boost.}
        \resumeItemListEnd
