    ...
    \resumeSubheading
      ...
      {Software Engineer}{Dec 2023 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Developed a cross-platform program to refine UAV detection for a GIS application using Boost libraries. Benchmarked point-in-polygon algorithms with a GeoJSON polygon database concurrently fetched from MongoDB.}
        \resumeItemListEnd
