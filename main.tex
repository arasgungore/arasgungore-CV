...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Programming:}{ C/C++, C\#, Java, Python, Go, JavaScript, MySQL, MATLAB, R, Git, Docker, ROS} \\ \vspace{3pt}
    ...
    \resumeSubheading
      ...
      {AI Research and Development Intern}{Jan 2022 \textbf{--} Feb 2022, Internship}
        \resumeItemListStart
            ...
            \resumeItem{Worked on a Turkish open-domain question answering system by fine-tuning a BERT base model transformer with PyTorch. Evaluated the exact match and F1 scores using different Turkish data sets and DeepMind's XQuAD data set and tabularized the evaluation results.}
        \resumeItemListEnd
