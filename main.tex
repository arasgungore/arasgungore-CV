    ...
    \resumeSubheading
      ...
      {Software Engineer}{Dec 2023 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Developed a cross-platform program to optimize UAV detection for a GIS application with Boost. Benchmarked point-in-polygon algorithms within a GeoJSON polygon database concurrently fetched from MongoDB.}
        \resumeItemListEnd
