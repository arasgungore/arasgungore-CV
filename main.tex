    ...
    \resumeSubheading
      ...
      {Undergraduate Researcher}{Jun 2022 \textbf{--} Aug 2022, Internship}
        \resumeItemListStart
            ...
            \resumeItem{Developed an Arduino Mega driver to activate a fluid dispenser and laser, monitor thermocouple readings, and for PID tuning to control the coil currents. Established a robust ROS-Arduino communication network by integrating handshaking and ROSSerial to simulate a 3D printing and magnetic programming process with Python.}
