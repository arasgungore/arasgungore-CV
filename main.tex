    ...
    \resumeSubheading
      ...
      {Undergraduate Research Assistant}{Jun 2022 \textbf{--} Aug 2022}
        \resumeItemListStart
            ...
            \resumeItem{Implemented Arduino Uno and Mega drivers that control a fluid dispenser, thermocouple amplifiers, a laser, and a coil set. Merged the drivers and used serial communication between the Arduino Mega driver and ROS nodes to simulate a 3D magnetic printing/programming process.}
        \resumeItemListEnd
